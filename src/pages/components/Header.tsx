...
const Header = () => {
  return (
    <header>
      <div className="border-customGrey-60 h-14 border-b md:h-24 ">
        <div className="border-customGrey-60 mx-auto h-full max-w-3xl md:border-x"></div>
      </div>
      <div className="border-customGrey-60 h-24 border-b">
        <div className="flex h-24 items-start justify-center md:items-center">
          <img
            ...
            alt="Back arrow"
          />
          <div className="border-customGrey-60 h-full w-[48rem] md:border-x  md:p-6">
            <nav className="flex h-full flex-col items-center justify-around md:flex-row">
              <h1>Contacts</h1>
              <div className="flex h-full items-center">
                ...
                <img
                  ...
                  alt="Profile picture"
                />
                <button className="bg-customGrey-60 flex items-center rounded-3xl px-3 py-2">
